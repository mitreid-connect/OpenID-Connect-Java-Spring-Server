...
@NamedQueries({
	...
	@NamedQuery(name = OAuth2RefreshTokenEntity.QUERY_BY_USERNAME, query = "select r from OAuth2RefreshTokenEntity r where r.authenticationHolder.userAuth.name = :" + OAuth2RefreshTokenEntity.PARAM_USERNAME),
...
public class OAuth2RefreshTokenEntity implements OAuth2RefreshToken {
	...
	public static final String QUERY_BY_USERNAME = "OAuth2RefreshTokenEntity.getByUsername";
