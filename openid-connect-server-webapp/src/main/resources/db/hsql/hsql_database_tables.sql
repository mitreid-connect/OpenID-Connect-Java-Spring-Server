...
CREATE TABLE IF NOT EXISTS client_details (
	...
	access_token_validity_seconds BIGINT, --CHECK (access_token_validity_seconds <= 31536000),
	refresh_token_validity_seconds BIGINT, --CHECK (refresh_token_validity_seconds <= 31536000),
