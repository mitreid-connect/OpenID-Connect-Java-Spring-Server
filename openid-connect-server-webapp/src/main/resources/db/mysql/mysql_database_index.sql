...
CREATE INDEX aha_oi_idx ON authentication_holder_authority(auth_holder_uuid);
CREATE INDEX ahe_oi_idx ON authentication_holder_extension(auth_holder_uuid);
CREATE INDEX ahrp_oi_idx ON authentication_holder_request_parameter(auth_holder_uuid);
CREATE INDEX ahri_oi_idx ON authentication_holder_resource_id(auth_holder_uuid);
CREATE INDEX ahrt_oi_idx ON authentication_holder_response_type(auth_holder_uuid);
CREATE INDEX ahs_oi_idx ON authentication_holder_scope(auth_holder_uuid);
