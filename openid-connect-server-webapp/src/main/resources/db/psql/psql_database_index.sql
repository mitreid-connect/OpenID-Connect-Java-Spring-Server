...
CREATE INDEX IF NOT EXISTS aha_oi_idx ON auth_holder_authority(owner_id);
CREATE INDEX IF NOT EXISTS ahe_oi_idx ON auth_holder_extension(owner_id);
CREATE INDEX IF NOT EXISTS ahrp_oi_idx ON auth_holder_request_parameter(owner_id);
CREATE INDEX IF NOT EXISTS ahri_oi_idx ON auth_holder_resource_id(owner_id);
CREATE INDEX IF NOT EXISTS ahrt_oi_idx ON auth_holder_resp_type(owner_id);
CREATE INDEX IF NOT EXISTS ahs_oi_idx ON auth_holder_scope(owner_id);
